               ...
               <tbody class="tbody">
                  <tr>
                     ...
                     <td><input type="text" name="mem_id"
                        ...
                        <input type="button" value="ID 중복확인" onclick="idCheck(mem_id.value)" />
                  </tr>
                  
                  <tr>
                     <td>비밀번호<span class="red">*</span></td>
                     <td><input type="password" name="mem_passwd" max_length="12"
                        minlength="8" required /> <span>8~12자리의 영문 대문자와 숫자, 특수문자만
                           입력</span></td>
                  </tr>
                  <tr>
                     <td>비밀번호확인<span class="red">*</span></td>
                     <td><input type="password" name="mem_repasswd"
                        max_length="12" minlength="8" required /></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                     <td>닉네임</td>
                     <td><input type="text" name="mem_nicname" maxlength="12"
                        minlength="2" /> <span>2~8자리 한글로만 입력</span></td>
                  </tr>
                  <tr>
                     ...
                     <td><input type="text" name="mem_email_id" id="email_id" />@
                        ...
                        <select name="email_sel" id="email_sel" style="font-size: 16px; height: 30px;"
                  ...
                  <tr>
                     ...
                     <td><input type="tel" name="mem_phone"
                        pattern="(010-[0-9]{4}-[0-9]{4})" required /> 예)010-1234-5678</td>
                  </tr>
                  <tr>
                     <td>성별</td>
                     <td><input type="radio" name="mem_gender" value="남" checked />남성&nbsp;&nbsp;&nbsp;
                        <input type="radio" name="mem_gender" value="여" />여성</td>
                  </tr>
                  <tr>
                     <td>생년월일<span class="red">*</span></td>
                     <td><script>
                        var today = new Date();
                        var toyear = parseInt(today.getFullYear()); //getFullYear() -> 년도만 받아오기 -> 정수로 변환
                        var start = toyear - 15; //네이버인 경우 만 14세 이상 회원가입
                        var end = toyear - 80;
                        ...
                        <div class="inputArea">
                           ...
                           <p>
                              <input type="text" name="userAddr1" id="address" size="100"
                                 ...
                                 placeholder="참고항목(도로명인 경우:지역 동이름과 아파트 이름)" /> <input
                                 type="text" name="userAddr2" id="detailAddress" size="45"
