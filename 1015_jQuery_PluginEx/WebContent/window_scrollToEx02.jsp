...
<body>
	...
	<div id="grape">
		...
		<div>
			<small><c:out value="껍질채 먹는 씨 없는 신품종 포도"/></small>
		</div>
	</div>
		<div id="strawberry">
		<div>
	...
	<div id="watermelon">
		...
		<div>
			<small><c:out value="달콤하고 시원한 유명 수박"/></small>
		</div>
	</div>
	<br><br>
	<input id="scroll-to-top" type="image" src="./images/top_image.png" onclick="javascript:window.scrollTo(0,0)">
</body>